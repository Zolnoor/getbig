...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    static final String TABLE1="CREATE TABLE workouts (_id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, date INTEGER, fulldate TEXT);";
    static final String TABLE2="CREATE TABLE exercises (_id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, pid INTEGER, clicked INTEGER, date INTEGER, fulldate TEXT);";
    ...
    static final String TABLE4="CREATE TABLE data (_id INTEGER PRIMARY KEY AUTOINCREMENT, wid INTEGER, eid INTEGER, date INTEGER, fulldate TEXT, reps1 INTEGER, weight1 INTEGER, notes1 STRING, " +
    ...
    static final String FULLDATE="fulldate";
